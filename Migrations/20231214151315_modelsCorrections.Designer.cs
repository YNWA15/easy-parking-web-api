...
namespace PublicParkingsSofiaWebAPI.Migrations
{
    ...
    [Migration("20231214151315_modelsCorrections")]
    partial class modelsCorrections
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PublicParkingsSofiaWebAPI.Models.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PublicParkingsSofiaWebAPI.Models.Vehicle", b =>
                {
                    b.HasOne("PublicParkingsSofiaWebAPI.Models.User", null)
                        .WithMany("Vehicles")
                        .HasForeignKey("UserId");
                });
